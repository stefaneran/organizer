...
import { TalkIconExtraSmall, TalkIconExtraSmallBlue } from '@components/core/Icons/TalkIcon';
import { PeopleIconExtraSmall, PeopleIconExtraSmallBlue } from '@components/core/Icons/PeopleIcon';
