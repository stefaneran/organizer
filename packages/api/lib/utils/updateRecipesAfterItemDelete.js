    ...
    for (const recipeId of Object.keys(recipes)) {
        ...
        for (const ingredient of ingredients) {
            ...
            if (shouldRemove && hasAlternatives) {
                ...
                for (const alternative of ingredient.alternatives) {
                    if (!itemIds.includes(alternative.itemId)) {
                        ...
                        const newIngredient = Object.assign(Object.assign({}, alternative), { isOptional: ingredient.isOptional, alternatives: ingredient.alternatives.filter((alt) => !itemIds.includes(alt.itemId) && alt.itemId !== alternative.itemId) });
                        hasChanges = true;
            ...
            // If ingredient shouldn't be removed, but has alternative(s)
                ...
                const updatedIngredient = Object.assign(Object.assign({}, ingredient), { alternatives: ingredient.alternatives.filter((alt) => !itemIds.includes(alt.itemId)) });
...
exports.default = updateRecipesAfterItemDelete;
//# sourceMappingURL=updateRecipesAfterItemDelete.js.map